# AI-OpsLog 第六阶段开发计划：集中日志收集与按需分析

## 1. 阶段目标

第六阶段目标是把 AI-OpsLog 从“单次日志分析 Demo”整理为“集中日志收集、统一存储、Web 展示筛选、按需 AI 分析”的完整演示项目。
...
- 支持多来源日志：系统、Zabbix、Prometheus、Grafana、Ansible、Docker、Kubernetes、Nginx、Redis、MySQL
